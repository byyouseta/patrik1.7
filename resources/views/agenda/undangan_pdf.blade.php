...
<body>
    <table class="table table-borderless">
        <thead>
            <tr>
                <th class="align-middle"><img src="adminlte/dist/img/LogoKemenkes.png" alt="Logo Kemenkes" width="80"
                        height="80"></th>
                ...
                <th class="align-middle"><img src="adminlte/dist/img/Logo.png" alt="Logo RSUP" width="80" height="80">
                </th>
            </tr>
        </thead>
    </table>
    ...
    <table class="table table-borderless">
        @for ($i = 0; $i < $urutan2; $i++)
            <tr>
                <td class="ml-5" style="width: 50%; line-height: 1.5pt;">{{ $nokiri . '. ' . $undangan[$i] }}
                </td>
                @php
                    $kanan = $urutan2 + $i;
                    $nokiri++;
