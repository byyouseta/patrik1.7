...
<head>
    ...
    <title>PATRIK (Rapat Elektronik) | Email Pengingat Rapat</title>
        ...
        <tr>
            <td align="center">
                <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590">
                        ...
                        <td align="center" class="section-img">
                            <a href=""
                                style=" border-style: none !important; display: block; border: 0 !important;"><img
                                    src="http://e-rapat.rsupsurakarta.co.id/adminlte/dist/img/Logo.png"
                                    style="display: block; width: 80px;" width="80" border="0" alt="" /></a>
                        </td>
                    </tr>
                    <tr align="center">
                        <td>
                            <div
                                style="color: #333333; font-size: 24px; font-family: 'Work Sans', Calibri, sans-serif; font-weight: 600; mso-line-height-rule: exactly; line-height: 23px;">
                    ...
                    <tr>
                        <td height="20" style="font-size: 20px; line-height: 20px;" colspan="2">&nbsp;</td>
                    </tr>
                    <tr>
                        <td align="center"
                            style="color: #343434; font-size: 24px; font-family: 'Work Sans', Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;"
                            class="main-header" colspan="2">


                            <div style="line-height: 35px">

                                Halo, <span style="color: #0067ac;">{{ $data['nama'] }}</span>
                    ...
                    <tr>
                        <td height="10" style="font-size: 10px; line-height: 10px;" colspan="2">&nbsp;</td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="2"
                            style="color: #000000; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                            Anda diundang dalam acara berikut ini</td>
                    </tr>

                    <tr>
                        <table border="0" width="490" align="center" cellpadding="0" cellspacing="0"
                            class="container590">
                            <tr
                                style="color: #000000; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                <td>Nama Rapat</td>
                                ...
                                <tr>
                                    <td align="center"
                                        ...
                                        <div style="line-height: 24px">
                                            ...
                                            Silahkan klik berikut untuk PRESENSI
                                        </div>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td align="center" colspan="2">
                            <table border="0" align="center" width="160" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td align="center"
                                        style="color: #659bff; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 26px;">


                                        <div style="line-height: 26px;">
                                            <a href="{{ $data['link'] }}"
                                                style="color: #ffffff; text-decoration: none;">Klik
                                                PRESENSI</a>
                                        </div>
                                    </td>
                                </tr>
        ...
        {{-- <tr>
            <td align="center">
                <table border="0" align="center" width="590" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td>
                            <table border="1" width="300" align="left" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    ...
                                    <td align="left" width="50">
                                        <img width="40" border="0" style="display: block; width: 40px;"
                                            src="http://e-rapat.rsupsurakarta.co.id/adminlte/dist/img/Logo.png"
                                            alt="" />
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td align="left"
                                        ...
                                        <div style="line-height: 24px;">
                                            ...
                                            <span style="color: #333333;">Mohon tidak membalas email ini!</span>
                                ...
                                <tr>
                                    <td align="center">
                                        <table align="center" border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td align="center">
                                                    <a style="font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;color: #0067ac; text-decoration: none;font-weight:bold;"
                                                        href="http://e-rapat.rsupsurakarta.co.id/">e-rapat.rsupsurakarta.co.id</a>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
