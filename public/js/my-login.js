...
$(function () {
    // author badge :)
    var author =
        '<div style="position: fixed;bottom: 0;right: 20px;background-color: #fff;box-shadow: 0 4px 8px rgba(0,0,0,.05);border-radius: 3px 3px 0 0;font-size: 12px;padding: 5px 10px;">Credit to <a href="https://twitter.com/mhdnauvalazhar">@mhdnauvalazhar</a> &nbsp;</div>';
    $("body").append(author);
